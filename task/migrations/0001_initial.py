    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('headers', models.TextField(blank=True, default="{'User-Agent':'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/110.0.0.0 Safari/537.36 Edg/110.0.1587.41'}", verbose_name='自定义请求头')),
                ('requestdata', models.TextField(blank=True, verbose_name='请求数据')),
